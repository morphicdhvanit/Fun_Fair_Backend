...
public class OrganizerRequestDetailsService {
	...
	public OrganizerRequestDetails addOrganizerRequest(AddOrganizerRequestDto dto, String userImagePath)
			throws IOException {
	...
	private AllOrganizerRequestDto convertToDto(OrganizerRequestDetails entity) {
		...
		dto.setOrganizerRequestStatus(entity.getOrganizerRequestStatus().getName());
	...
	@Transactional
	public OrganizerRequestDetails updateRequestStatus(String organizerRequestId, String requestStatus) {
	...
	private OrganizerRequestStatusEnum getStatusEnum(String requestStatus) {
		...
		throw new IllegalArgumentException(
				"Invalid request status: " + requestStatus + ". Allowed values: in_progress, approved, rejected");
	}
